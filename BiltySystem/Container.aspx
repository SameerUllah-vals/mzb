<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Container.aspx.cs" Inherits="BiltySystem.Container" %>
                            ...
                            <div class="content">                                
                                <div role="form">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtContainerNoModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Container type:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtContainerTypeModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Shipping Company</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtShippingModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtOwnerModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtownerContactModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Owner Ship Type:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtOwnerTypeModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            ...
                                            <asp:TextBox ID="txtOwnerContact" runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Owner Ship Type</label>
                                            <asp:DropDownList ID="ddlOwnerShipType" runat="server" CssClass="form-control">
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Container</h2> 
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="ID, isActive" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                                        ...
                                        <asp:BoundField DataField="ShippingCompany" HeaderText="Shipping Company"></asp:BoundField>
                                        <asp:BoundField DataField="Owner" HeaderText="Owner"></asp:BoundField>
                                        <asp:BoundField DataField="OwnerContact" HeaderText="OwnerContact"></asp:BoundField>
                                        <asp:BoundField DataField="OwnershipType" HeaderText="OwnerShip"></asp:BoundField>
