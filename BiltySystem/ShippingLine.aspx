<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="ShippingLine.aspx.cs" Inherits="BiltySystem.ShippingLine" %>
                            ...
                            <div class="content">                                
                                 <div role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">ContactPerson:</label>
                                                <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            ...
                                            <asp:TextBox ID="txtSecondryPhone" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Lift Off Lift On Charges</label>
                                            <asp:TextBox ID="txtLoLoCharges" runat="server" CssClass="form-control" TextMode="Number"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Shipping Line</h2> 
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="ShippingLineID, isActive" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                                        ...
                                        <asp:BoundField DataField="ContactPerson" HeaderText="ContactPeson"></asp:BoundField>
                                        <asp:BoundField DataField="PrimaryContact" HeaderText="PrimaryContact"></asp:BoundField>
                                        <asp:BoundField DataField="LiftOffLiftOnCharges" HeaderText="LOLO"></asp:BoundField>     
