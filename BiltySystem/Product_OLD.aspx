<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Product_OLD.aspx.cs" Inherits="BiltySystem.Product_OLD" %>
                            ...
                            <div class="content">                                
                                  <div role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Gener:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblGener" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Nature:</label>
                                                <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                     ...
                                     <div class="form-group col-md-3 pull-left">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Gener</label>
                                            <asp:DropDownList ID="ddlGener" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Nature</label>
                                            <asp:DropDownList ID="ddlnature" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                        </div>
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            ...
                                            <asp:DropDownList ID="ddlDimension" runat="server" CssClass="form-control">
                                                <asp:ListItem>-Select Dimension-</asp:ListItem>
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <asp:BoundField DataField="PackageType" HeaderText="PackagingType"></asp:BoundField>
