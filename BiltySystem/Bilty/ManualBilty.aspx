<%@ Page Title="" Language="C#" MasterPageFile="~/Bilty/BiltySystem.Master" AutoEventWireup="true" CodeBehind="ManualBilty.aspx.cs" Inherits="BiltySystem.Bilty.ManualBilty" %>
                        ...
                        <div id="general_validate" action="javascript:;" novalidate="novalidate">
                            <div class="row">
                                        ...
                                        <div class="form-group">
                                            <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                                <ContentTemplate>
                                                    ...
                                                    <div class="controls">
                                                        <asp:ImageButton ID="imgOnOff" runat="server" ImageUrl="~/assets/images/Off.png" CssClass="m-t-5" OnClick="imgOnOff_Click" Width="15%" />
                                                    </div>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                ...
                                <div class="col-xs-4">                   
                                    ...
                                    <%--<asp:LinkButton ID="lnkPaidToPay" runat="server" OnClick="lnkPaidToPay_Click" CssClass="switchery switchery-large" style="background-color: rgb(255, 255, 255); border-color: rgb(223, 223, 223); box-shadow: rgb(223, 223, 223) 0px 0px 0px 0px inset; transition: border 0.5s ease 0s, box-shadow 0.5s ease 0s;" ToolTip="Cancelled Bilty">
                                        <small style="left: 0px; transition: background-color 0.5s ease 0s, left 0.25s ease 0s;"></small>
                                    </asp:LinkButton>--%>
                                    
                                    <%--Red On          <small style="left: 26px; background-color: rgb(255, 255, 255); transition: background-color 0.5s ease 0s, left 0.25s ease 0s;"></small>--%>
                                    <%--White Off       <small style="left: 0px; transition: background-color 0.5s ease 0s, left 0.25s ease 0s;">--%>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <asp:GridView ID="gvVehicleInfo" runat="server" OnRowDataBound="gvVehicleInfo_RowDataBound" Font-Size="10px" AutoGenerateColumns="false" DataKeyNames="VehicleSize">
                                                                        <Columns>
                                                                           ...
                                                                           <%-- <asp:TemplateField HeaderText="VehicleManual">
                                                                                <ItemTemplate>
                                                                                       <asp:DropDownList ID="ddlVehicleManualNo" runat="server" OnSelectedIndexChanged="ddlVehicleManualNo_SelectedIndexChanged" AutoPostBack="true">
                                                                            ...
                                                                            <asp:TemplateField HeaderText="VehicleRegNo">
                                                                                <ItemTemplate>
                                                                                    ...
                                                                                    <%-- <asp:DropDownList ID="ddlVehicleNo" runat="server" OnSelectedIndexChanged="ddlVehicleNo_SelectedIndexChanged" AutoPostBack="true" Visible="false"></asp:DropDownList>--%>
                                ...
                                <div class="col-lg-12">
                                    <asp:UpdatePanel ID="UpdatePanel10" runat="server">
                                        <ContentTemplate>
                                            <section class="box ">
                                                <header class="panel_header">
                                                    <h2 class="title pull-left">Freights</h2>
                                                    <%--<div class="actions panel_actions pull-right">
                                                        <a class="box_toggle fa fa-chevron-down"></a>
                                                            ...
                                                            <div class="col-xs-12">
                                                                ...
                                                                <div class="col-xs-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <asp:TextBox ID="txtBiltyFreight" runat="server" CssClass="form-control" TextMode="Number" OnTextChanged="txtBiltyFreight_TextChanged" AutoPostBack="true" Enabled="false"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xs-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="controls">
                                                                            <asp:TextBox ID="txtFreight" runat="server" CssClass="form-control" TextMode="Number" OnTextChanged="txtFreight_TextChanged" AutoPostBack="true" Enabled="false"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xs-3">
                                ...
                                <div id="general_validate" action="javascript:;" novalidate="novalidate">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <%--<asp:LinkButton ID="lnkSaveNext" runat="server" CssClass="btn btn-info m-t-25" ToolTip="Click to Save & Add Next Bilty" OnClick="lnkSaveNext_Click"><i class="fas fa-angle-double-right"></i> | Save & Next</asp:LinkButton>
