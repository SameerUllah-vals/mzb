<%@ Page Title="" Language="C#" MasterPageFile="~/Bilty/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Search_TEMP.aspx.cs" Inherits="BiltySystem.Bilty.Search_TEMP" %>
                                ...
                                <div id="general_validate" action="javascript:;" novalidate="novalidate">
                                    <div class="row">
                                        ...
                                        <asp:GridView ID="gvBilty" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" Font-Size="10px"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="OrderNo" HeaderText="Trip #" ItemStyle-HorizontalAlign="Center" />
