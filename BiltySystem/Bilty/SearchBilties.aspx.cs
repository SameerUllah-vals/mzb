...
{
    public partial class SearchBilties : System.Web.UI.Page
    {
        ...
        public void GetBilties(string sortExpression = "")
        {
            try
            {
                ...
                else
                {
                    ...
                    dtBilties = dml.GetBilties(Keyword, Query);
                }
                    ...
                    if (dtContainers.Rows.Count > 0)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                if (isBilled == true)
                                {
                                    lnkUpdateDropdown.CssClass = "btn btn-primary btn-border dropdown-toggle btn-xs disabled";
                                    lnkInvoice.Enabled = false;
                    ...
                    if (dtContainers.Rows.Count > 0)
                    {
                        ...
                        if (allReceived == true)
                        {
                            ...
                            if (dtOrderVehicle.Rows.Count > 0)
                            {
                                ...
                                if (FactoryAdvance > 0)
                                {
                                    CustomerTransaction(CustomerCompanyID, FactoryAdvance, "Credit", "Paid to driver against bilty# " + OrderNo + " as factory advance ");
                                }
