...
{
    public partial class BiltySystem : System.Web.UI.MasterPage
    {
        #region Members
                                ...
                                if (dtMainMenus.Rows.Count > 0)
                                {
                                    for (int i = 0; i < dtMainMenus.Rows.Count; i++)
                                    {
                                        ...
                                        if (dtSubMenues.Rows.Count > 0)
                                        {
                                            ...
                                            //LeftSideBar.InnerHtml += "<li><a href=\"#\"><i class=\"" + MenuIcon + "\"></i><span>" + dtMainMenus.Rows[i]["MenuName"].ToString() + "</span></a></li>";
                                            //LeftSideBar.InnerHtml += "<ul class=\"sub-menu\">";
                                            ...
                                            for (int j = 0; j < dtSubMenues.Rows.Count; j++)
                                            {
                                                ...
                                                //LeftSideBar.InnerHtml += "<li><i class=\"" + SubmenuIcon + "\"></i><span><a href = \"" + dtSubMenues.Rows[j]["url"].ToString() + LoginID + "\"> " + dtSubMenues.Rows[j]["FormName"].ToString() + "</span></a></li>";
                                            }
