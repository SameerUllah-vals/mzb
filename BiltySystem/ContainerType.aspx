<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="ContainerType.aspx.cs" Inherits="BiltySystem.ContainerType" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                                ...
                                <div role="form">
                                    ...
                                    <hr />
                                     <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Cubic Capacity:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblCubicCapacity" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Payload:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblPayload" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Tare Weight:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblTareWeight" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                          ...
                                          <asp:DropDownList ID="ddlUnitType" runat="server" CssClass="form-control">
                                             <asp:ListItem>--Select Unit--</asp:ListItem>
                                               <asp:ListItem Selected Value="Meter">Meter</asp:ListItem>
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            ...
                                            <asp:TextBox ID="txtCubicCapacity" runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" CssClass="form-control"></asp:TextBox>
                                        </div>
                                         <div class="form-group col-md-3 pull-left">
                                            <label>Tare Weight</label>
                                            <asp:TextBox ID="txtTareWeight" runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" CssClass="form-control"></asp:TextBox>
                                        </div>
                                          <div class="form-group col-md-3 pull-left">
                                            <label>Payload</label>
                                            <asp:TextBox ID="txtPayload" runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" CssClass="form-control"></asp:TextBox>
                                        </div>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Container Type</h2> 
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="ContainerTypeID, isActive" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                                        ...
                                        <asp:BoundField DataField="ContainerType" HeaderText="Name"></asp:BoundField>
