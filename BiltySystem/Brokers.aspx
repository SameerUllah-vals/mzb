<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Brokers.aspx.cs" Inherits="BiltySystem.Brokers" %>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                     ...
                                     <div class="form-group col-md-3 pull-left">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Phone</label>
                                            <asp:TextBox ID="txtPhone" runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Secondary Phone</label>
                                            <asp:TextBox ID="txtPhone2" runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Home No</label>
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            <label>NIC</label>
                                            <asp:TextBox ID="txtNIC" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Brokers</h2> 
