<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Section.aspx.cs" Inherits="BiltySystem.Section" %>
                            ...
                            <div class="content">                                
                              <div role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">List Of Person:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lbllistof" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-md-6 pull-left">
                                            <label>List Of Person</label>
                                            <asp:TextBox ID="ListOfPerson" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Section</h2> 
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <asp:BoundField DataField="ListofPerson" HeaderText="ListOfPerson"></asp:BoundField>
