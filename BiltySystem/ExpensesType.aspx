<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="ExpensesType.aspx.cs" Inherits="BiltySystem.ExpensesType" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Expenses Type</h2> 
                                ...
                                <div class="actions panel_actions pull-right">
                                    ...
                                    <asp:LinkButton ID="lnkPrint" runat="server" CssClass="box_setting fas fa-print" OnClick="lnkPrint_Click" ToolTip="Click to Add New"></asp:LinkButton>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="ExpensesTypeID, isActive" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                                        ...
                                        <asp:BoundField DataField="ExpensesTypeCode" HeaderText="Code"></asp:BoundField>
                                        <asp:BoundField DataField="ExpensesTypeName" HeaderText="Name"></asp:BoundField>
                                        <asp:BoundField DataField="Remarks" HeaderText="Description"></asp:BoundField>
                                        <asp:BoundField DataField="isActive" HeaderText="Active"></asp:BoundField>
                                         ...
                                         <%-- SSRS Report --%>
                                         <%-- <rsweb:reportviewer ID="rvBankLedger" runat="server" 
                                              Width="100%" Height="800px" ShowPageNavigationControls="False">
                                              <LocalReport ReportPath="PrintView/TempReport.rdlc"></LocalReport>
                                          </rsweb:reportviewer>--%>
                                         <%-- SSRS Report --%>
                                    </div>
                                </div>
