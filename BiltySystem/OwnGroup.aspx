<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="OwnGroup.aspx.cs" Inherits="BiltySystem.OwnGroup" %>


<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Own Group</title>
    <style>        
        .modalBackground {
                            ...
                            <div class="content">                                
                                <div role="form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Own Group:</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtOtherModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Organization:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtOrganiModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtAddressModal" TextMode="MultiLine" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="txtDescriptionModal" TextMode="MultiLine" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-3 pull-left demo-checkbox">
                                            <label>Company Access</label>
                                            <asp:TextBox ID="txtCompanyAccess" runat="server" Rows="3" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        
                                        <div class="col-md-6 pull-right demo-checkbox" style="height: 200px; overflow-y: scroll;">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="GroupID, isActive" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
