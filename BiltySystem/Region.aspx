<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Region.aspx.cs" Inherits="BiltySystem.Region" %>
                    ...
                    <div class="col-sm-12 col-md-12">
                     ...
                     <div role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Provonce:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblProvince" TextMode="MultiLine" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Region</h2> 
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="ID, Active" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                               ...
                               <asp:BoundField DataField="Code" HeaderText="Code"></asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="ProvinceName" HeaderText="ProvinceID"></asp:BoundField>
