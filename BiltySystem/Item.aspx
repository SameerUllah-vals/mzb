<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Item.aspx.cs" Inherits="BiltySystem.Item" %>
                                 ...
                                 <div role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblDescription" TextMode="MultiLine" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                          ...
                                          <%-- <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblOwner" TextMode="MultiLine" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>--%>
                                    ...
                                    <!--/row-->
                                      <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">isGeneral?:</label>
                                                <div class="col-md-9">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md- pull-left demo-checkbox">
                                                <asp:CheckBox ID="cbGeneral" runat="server" />
                                                <label for="cbGeneral">General</label>
                                            </div>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Items</h2> 
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="ItemID, isActive" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                                         ...
                                         <asp:BoundField DataField="ItemCode" HeaderText="Code"></asp:BoundField>
                                        <asp:BoundField DataField="ItemName" HeaderText="Item"></asp:BoundField>
                                        <asp:BoundField DataField="isGeneralItem" HeaderText="General?"></asp:BoundField>
