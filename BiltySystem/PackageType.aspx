<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="PackageType.aspx.cs" Inherits="BiltySystem.PackageType" %>
                            ...
                            <div class="content">                                
                                  <div role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Master Carton:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblMasterCarton" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                      ...
                                      <div class="form-group col-md-3 pull-left">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Length</label>
                                            <asp:TextBox ID="txtlength"  onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Width</label>
                                            <asp:TextBox ID="txtwidth"  onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Height</label>
                                            <asp:TextBox ID="txtheight"  onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Weight</label>
                                            <asp:TextBox ID="txtWeight" runat="server"  onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6 pull-left">
                                            ...
                                            <div class="col-md- pull-left demo-checkbox">
                                                <asp:CheckBox ID="cbMasterCarton" runat="server" />
                                                <label for="cbMasterCarton">Master Carton</label>
                                            </div>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Package Type</h2> 
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="PackageTypeID, isActive" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                                             ...
                                             <asp:BoundField DataField="PackageTypeCode" HeaderText="Code"></asp:BoundField>
                                        <asp:BoundField DataField="PackageTypeName" HeaderText="Name"></asp:BoundField>
