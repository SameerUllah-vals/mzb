<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="CreateInvoice.aspx.cs" Inherits="BiltySystem.CreateInvoice" %>
        ...
        <section class="wrapper main-wrapper row" style=''>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <asp:Panel class="col-xs-12" id="SearchOrders" runat="server" DefaultButton="lnkSearch">
                        <section class="box ">
                            <header class="panel_header">
                            ...
                            <div class="content-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="form-group">
                                            <label class="form-label" for="email-1">Shipping Line</label>
                    ...
                    <div class="col-xs-12" id="ResultOrders" runat="server">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Select Containers</h2>
                                ...
                                <asp:LinkButton ID="lnkGenerateInvoice" runat="server" CssClass="btn btn-xs btn-info pull-right m-r-10 m-t-30" OnClick="lnkGenerateInvoice_Click"><i class="fas fa-file-invoice"></i> | Generate Bill</asp:LinkButton>
                            </header>
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-md-6 col-sm-12 col-xs-12 pull-left">
                                        <asp:GridView ID="gvAllContainers" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" Font-Size="10px" 
                                            DataKeyNames="OrderConsignmentID, Rate, CustomerCompanyID" OnRowDataBound="gvAllContainers_RowDataBound">
                                            <Columns>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                    ...
                                    <div class="col-md-6 col-sm-12 col-xs-12 pull-left">
                                        <asp:GridView ID="gvSelectedContainers" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" Font-Size="10px" 
                                            DataKeyNames="OrderConsignmentID, CustomerCompanyID">
                                            <Columns>
                                                <asp:BoundField DataField="ContainerNo" HeaderText="Container #" />
                                                <asp:BoundField DataField="RecordedDate" HeaderText="Order Date" />
                                                <asp:BoundField DataField="OrderNo" HeaderText="Shipping" />
                                                <asp:BoundField DataField="AssignedVehicle" HeaderText="Vehicle" />
                    ...
                    <asp:Panel ID="pnlConfirm" runat="server" CssClass="row" style="background-color: white; padding: 20px; border: 1px solid black;" Width="400px">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtCustomerBillNo" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <h4><asp:Label ID="lblModalTitle" runat="server"></asp:Label></h4>                       
                       
                        <div class="col-md-12">
                            <label>Note: Provide Customer Bill # if wish so</label>
                        </div>
                         <div class="col-md-12">
