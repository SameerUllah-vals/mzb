<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Group.aspx.cs" Inherits="BiltySystem.WebForm3" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            //alert(123);
            $("#gvResult").prepend($("<thead></thead>").append($(this).find("tr:first"))).dataTable();
            $('#gvResult').DataTable();
