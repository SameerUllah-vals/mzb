<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="BiltySystem.Product" %>
                            ...
                            <div class="content">                                
                                  <div role="form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                             ...
                                             <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Package:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblPkg" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Dimension:</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Volume:</label>
                                                <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Product</label><asp:HiddenField ID="hfEditID" runat="server" />
                                      ...
                                      <div class="form-group col-md-3 pull-left">
                                            <label>Weight</label>
                                            <asp:TextBox ID="txtWeight" runat="server" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" CssClass="form-control"></asp:TextBox><asp:HiddenField ID="HiddenField1" runat="server" />
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Unit</label>
                                           ...
                                           <div class="form-group col-md-3 pull-left">
                                            <label>Length</label>
                                            <asp:TextBox ID="txtLength" runat="server" CssClass="form-control"></asp:TextBox><asp:HiddenField ID="HiddenField4" runat="server" />
                                        </div>
                                      <div class="form-group col-md-3 pull-left">
                                            <label>Width</label>
                                            <asp:TextBox ID="txtWidth" runat="server"  CssClass="form-control"></asp:TextBox><asp:HiddenField ID="HiddenField3" runat="server" />
                                        </div>
                                             <div class="form-group col-md-3 pull-left">
                                            <label>Height</label>
                                            <asp:TextBox ID="txtHeight" runat="server"  CssClass="form-control"></asp:TextBox><asp:HiddenField ID="HiddenField2" runat="server" />
                                        </div>
                                              <div class="form-group col-md-3 pull-left">
                                            <label>Unit</label>
                                          ...
                                          <div class="form-group col-md-3 pull-left">
                                            <label>Volume</label>
                                            <asp:TextBox ID="txtVolume" runat="server" CssClass="form-control"></asp:TextBox><asp:HiddenField ID="HiddenField5" runat="server" />
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="ID, Status" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                                        ...
                                        <asp:BoundField DataField="PackageTypeName" HeaderText="PackagingType"></asp:BoundField>
                                        <asp:BoundField DataField="Category" HeaderText="Category"></asp:BoundField>
                                        <asp:BoundField DataField="Gener" HeaderText="Gener"></asp:BoundField>
