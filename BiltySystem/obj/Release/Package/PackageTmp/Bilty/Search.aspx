...
<%@ Page Title="" Language="C#" MasterPageFile="~/Bilty/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="BiltySystem.Bilty.Search" %>
                            ...
                            <ContentTemplate>
                                ...
                                <div id="general_validate" action="javascript:;" novalidate="novalidate">
                                    <div class="row">
                                        ...
                                        <asp:HiddenField ID="hfSelectedBillToCustomer" runat="server" />
                                        ...
                                        <asp:GridView ID="gvBilty" runat="server" CssClass="table table-hover" AutoGenerateColumns="false" Font-Size="10px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="---" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <div class="btn-group bottom15 right15">
                                                            <div class="dropdown">
                                                                <asp:LinkButton CssClass="btn btn-primary btn-border dropdown-toggle btn-xs" type="button" id="UpdateDropdown" runat="server" data-toggle="dropdown" aria-expanded="true">
                                                                    Documents
                                                ...
                                                <asp:TemplateField HeaderText="Update">
                                                    <ItemTemplate>
                                                        <div class="dropdown">
                                                            <asp:LinkButton ID="lnkUpdateDropdown" runat="server" CssClass="btn btn-xs btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true">
                                    ...
                                    <div class="row">                                
                                        <asp:Panel ID="pnlBiltyContainerInputs" runat="server" class="col-md-12" Visible="false">
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <asp:DropDownList ID="ddlContainerType" runat="server" OnSelectedIndexChanged="ddlContainerType_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-2">
                                            ...
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <asp:DropDownList ID="ddlContainerPickup" runat="server" OnSelectedIndexChanged="ddlContainerPickup_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-2">
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <asp:DropDownList ID="ddlContainerDropoff" runat="server" OnSelectedIndexChanged="ddlContainerDropoff_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control"></asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-2">
                                        ...
                                        <div id="divContainerDetails" runat="server" class="col-md-12">                                            
                                            ...
                                            <asp:GridView ID="gvContainer" runat="server" Font-Size="10px" CssClass="table table-hover" AutoGenerateColumns="false"
                                                EmptyDataText="No container assigned to selected bilty" OnRowCommand="gvContainer_RowCommand" DataKeyNames="OrderConsignmentID, Status, IsBilled" OnRowDataBound="gvContainer_RowDataBound">
                                                <Columns>
