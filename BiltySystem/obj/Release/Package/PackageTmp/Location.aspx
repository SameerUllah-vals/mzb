<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Location.aspx.cs" Inherits="BiltySystem.Location" %>
                            ...
                            <div class="content">                                
                                 <div role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblProvinceModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblCityModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Region:</label>
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblRegionModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9">
                                                    <asp:Label ID="lblAreaModal" runat="server"></asp:Label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                      ...
                                      <div class="form-group col-md-3 pull-left">
                                        ...
                                        <%--<div class="form-group col-md-3 pull-left">
                                            <label>Region</label>
                                            <asp:DropDownList ID="ddlRegion" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlRegion_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                        </div>--%>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Area</label>
                                        ...
                                        <div class="form-group col-md-4 pull-left">
                                            <label>Address</label>
                                            <asp:TextBox ID="txtAddress" runat="server"  TextMode="MultiLine" Width="100%" Rows="1" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        <div class="form-group col-md-4 pull-left">
                                            <label>Description</label>
                                            <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Width="100%" Rows="1" CssClass="form-control"></asp:TextBox>
                                        </div>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Location</h2> 
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <asp:GridView ID="gvResult" runat="server" Width="100%" EmptyDataText="No Record found" AutoGenerateColumns="false"
                                            CssClass="table table-hover" Font-Size="12px" Font-Names="Open Sans" DataKeyNames="PickDropID, isActive" BackColor="White" OnRowCommand="gvResult_RowCommand" OnRowDataBound="gvResult_RowDataBound">
                                            <Columns>
                                           ...
                                           <asp:BoundField DataField="PickDropCode" HeaderText="Code"></asp:BoundField>
                                        <asp:BoundField DataField="PickDropLocationName" HeaderText="Name"></asp:BoundField>
                                        <%--<asp:BoundField DataField="ProvinceName" HeaderText="Province"></asp:BoundField>--%>
                                        <asp:BoundField DataField="CityName" HeaderText="City"></asp:BoundField>
                                        <%--<asp:BoundField DataField="RegionName" HeaderText="Region"></asp:BoundField>--%>
                                        <asp:BoundField DataField="AreaName" HeaderText="Area"></asp:BoundField>
                                        <asp:BoundField DataField="LocationTypeName" HeaderText="Type"></asp:BoundField>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
