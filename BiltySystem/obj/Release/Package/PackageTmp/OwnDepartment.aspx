<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="OwnDepartment.aspx.cs" Inherits="BiltySystem.OwnDepartment" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Own Department</title>
    <style>        
        .modalBackground {
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Own Department</h2> 
                                <%--<h2 class="title pull-left">Own Department</h2> --%>
