<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="Voucher.aspx.cs" Inherits="BiltySystem.Voucher" %>
                            ...
                            <div class="content">                                
                                <div role="form">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Voucher No:</label>
                                                <div class="col-md-9">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Vehicle No:</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group row">
                                                <label class="control-label text-right col-md-3">Expense Type:</label>
                                                <div class="col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                            ...
                                            <asp:DropDownList ID="ddlVehicle" CssClass="form-control" runat="server"></asp:DropDownList>
                                        </div>
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Expense Type</label>
                                            <asp:DropDownList ID="ddlExpense" CssClass="form-control" runat="server"></asp:DropDownList>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group col-md-3 pull-left">
                                           ...
                                           <div class="form-group col-md-3 pull-left">
                                            <label>Expense Type</label>
                                           <asp:DropDownList ID="ddlExpenseSearch" runat="server" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                        
                                        <div class="form-group col-md-3 pull-left">
                                            <label>Vendor</label>
                                            <asp:TextBox ID="txtVendorSearch" runat="server" Rows="1" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group col-lg-12 pull-left">
                                                ...
                                                <asp:LinkButton ID="lnkVoucherSearch" runat="server" CssClass="btn btn-success pull-right m-l-10" OnClick="lnkVoucherSearch_Click"><i class="fa fa-search"></i> | Search</asp:LinkButton>
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Voucher</h2> 
                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <asp:BoundField DataField="RegNo" HeaderText="Vehicle"></asp:BoundField>
                                        <asp:BoundField DataField="ExpensesTypeName" HeaderText="Expense"></asp:BoundField>
