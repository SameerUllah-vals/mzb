<%@ Page Title="" Language="C#" MasterPageFile="~/BiltySystem.Master" AutoEventWireup="true" CodeBehind="OwnCompany.aspx.cs" Inherits="BiltySystem.OwnCompany" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Own Company</title>
    <style>        
        .modalBackground {
                    ...
                    <div class="col-xs-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Own Company</h2> 
