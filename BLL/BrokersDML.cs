...
namespace BLL
{
    public class BrokersDML
    {
        ...
        public DataTable GetBrokerByVehicle(Int64 VehicleID)
        {
            //Creating object of DAL class
            CommandData _commnadData = new CommandData();
            ...
            {
                _commnadData._CommandType = CommandType.Text;
                _commnadData.CommandText = "SELECT * FROM Broker WHERE VehicleID = " + VehicleID;
        ...
        public DataTable GetActiveBrokerByVehicle(Int64 VehicleID)
        {
            //Creating object of DAL class
            CommandData _commnadData = new CommandData();
            ...
            {
                _commnadData._CommandType = CommandType.Text;
                _commnadData.CommandText = "SELECT b.* FROM Brokers b INNER JOIN Vehicle v ON v.BrokerID = b.ID WHERE v.VehicleID = " + VehicleID + " AND ISNULL(v.isActive, 0) = 1 AND ISNULL(v.IsDeleted, 0) = 0 ORDER BY b.Name ASC";
        ...
        public DataTable GetActiveBroker()
        {
            ...
            {
                _commnadData._CommandType = CommandType.Text;
                _commnadData.CommandText = "SELECT * FROM Brokers WHERE ISNULL(isActive, 0) = 1 ORDER BY Name ASC";
