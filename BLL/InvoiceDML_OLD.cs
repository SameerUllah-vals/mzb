...
namespace BLL
{
    public class InvoiceDML
    {
        ...
        public DataTable GetCompletedContainers()
        {
            ...
            {
                _commnadData._CommandType = CommandType.Text;
                _commnadData.CommandText = "SELECT oc.*, o.OrderNo, o.RecordedDate, o.CustomerCompanyID FROM OrderConsignment oc INNER JOIN [Order] o ON o.OrderID = oc.OrderID WHERE ISNULL(oc.Status, 0) = 0 AND ISNULL(PaymentStatus, 0) = 0";
        ...
        public DataTable GetCompletedContainers(string QueryExpression)
        {
            ...
            {
                _commnadData._CommandType = CommandType.Text;
                _commnadData.CommandText = "SELECT oc.*, o.OrderNo, o.RecordedDate, o.CustomerCompanyID, ce.Amount AS WeighmentAmount FROM OrderConsignment oc INNER JOIN [Order] o ON o.OrderID = oc.OrderID INNER JOIN ContainerExpenses ce ON ce.ContainerID = oc.OrderConsignmentID WHERE ISNULL(oc.Status, 0) = 1 AND ISNULL(PaymentStatus, 0) = 0 AND ISNULL(IsInvoiced, 0) = 0 " + QueryExpression;
        ...
        public DataTable GetInvoices()
        {
            ...
            {
                _commnadData._CommandType = CommandType.Text;
                _commnadData.CommandText = "SELECT DISTINCT InvoiceNo, CustomerCompany, Total FROM Invoices i";
        ...
        public DataTable GetInvoices(string InvoiceNumber)
        {
            //Creating object of DAL class
            CommandData _commnadData = new CommandData();
            ...
            {
                _commnadData._CommandType = CommandType.Text;
                _commnadData.CommandText = "SELECT * FROM Invoices WHERE InvoiceNo = '" + InvoiceNumber + "'";
        ...
        public DataTable GetContainers(string ContainerIDs)
        {
            ...
            {
                _commnadData._CommandType = CommandType.Text;
                _commnadData.CommandText = "SELECT oc.*, o.RecordedDate FROM OrderConsignment oc INNER JOIN [Order] o ON o.OrderID = oc.OrderID WHERE OrderConsignmentID IN (" + ContainerIDs + ")";
        ...
        public int InsertInvoice(string InvoiceNo, string CustomerCompany, Int64 ContainerID, double Total, Int64 CreatedBy)
        {
            ...
            try
            {
                ...
                commandData.CommandText = "INSERT INTO Invoices (InvoiceNo, CustomerCompany, OrderConsignmentID, Total, CreatedBy, CreatedDate) VALUES ('" + InvoiceNo + "', '" + CustomerCompany + "', " + ContainerID + ", " + Total + ", " + CreatedBy + ", GETDATE()); SELECT SCOPE_IDENTITY();";
        ...
        public int InvoiceToContainer(Int64 ContainerID)
        {
            //Creating object of DAL class
            CommandData commandData = new CommandData();
            ...
            {
                commandData._CommandType = CommandType.Text;
                commandData.CommandText = "UPDATE OrderConsignment SET [IsInvoiced] = 1 WHERE [OrderConsignmentID] = " + ContainerID;
